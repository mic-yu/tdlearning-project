...
def load_wandb_model(run_path, model_path, device, input_size=6):
...
if __name__ == '__main__':
    ...
    artifact_name = "dpinchuk-university-of-wisconsin-madison/td_committor_ep400/2025-12-12_06-37-06_mvjlar04_best_model:v0"
