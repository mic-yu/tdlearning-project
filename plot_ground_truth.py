...
if __name__ == "__main__":
    ...
    path = "./data/ground_truth/near_ball_dx_100_scale_10_h_inf_2025-11-26_15-43-30.pkl" #near ball
    #path = "./data/ground_truth/fixed_agent_0_scale_10_h_inf_2025-12-12_16-54-28.pkl"
