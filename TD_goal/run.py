...
def wandb_sweep_objective_committor_mc(hydra_cfg):
    """
...
def run(cfg):
    ...
    if cfg.mode == "sweep":
        ...
        if cfg.algorithm == "td":
            ...
            message = f"cfg.algorithm {cfg.algorithm} is not implemented."
            raise ValueError(message)
        ...
        if cfg.algorithm == "td":
            ...
            partial_function = partial(wandb_sweep_objective_committor_mc, hydra_cfg=cfg)
            wandb.agent(sweep_id = cfg.wandb_sweep.sweep_id, 
                        function=partial_function,
                        entity=cfg.wandb.entity,
                        project=cfg.wandb.project,
